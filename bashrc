...
function pc {
    [ -d .git ] && echo " ($(git name-rev --name-only @)) "
}
...
export PS1="\n\[\033[00;32m\]\u\[\033[00m\]@\[\033[35m\]\h \[\033[33m\]\w\[\033[00;36m\]\$(pc)\n\$(if [[ \$? == 0 ]]; then echo -ne \"\[\033[0;32m\]\$?\"; else echo -ne \"\[\033[0;31m\]\$?\"; fi)\[\033[00;36m\] \$\[\033[00m\] "
